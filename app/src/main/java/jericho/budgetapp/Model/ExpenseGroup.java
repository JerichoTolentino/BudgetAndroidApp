...
public class ExpenseGroup implements Priceable, Serializable
{
     ...
     * @param expenses The Expenses to add to the ExpenseGroup.
     */
    @SafeVarargs
    public ExpenseGroup(long id, String name, long price, String category, String description, KeyValuePair<Expense, Integer>... expenses)
    {
        this.id = id;
        this.price = price;
        this.name = name;
